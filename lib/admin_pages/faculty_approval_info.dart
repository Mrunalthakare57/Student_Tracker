...
class FacultyApprovalInfoPage extends StatefulWidget {
  ...
  const FacultyApprovalInfoPage({Key? key, required this.userId}) : super(key: key);

  @override
  _FacultyApprovalInfoPageState createState() => _FacultyApprovalInfoPageState();
}
...
class _FacultyApprovalInfoPageState extends State<FacultyApprovalInfoPage> {
  ...
  Future<void> updateUserStatus(String status) async {
    try {
      ...
      String emailSubject = 'Faculty registration';
